        ...
        <main className="bg-[#f8fafc] min-h-screen pb-12">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-[-60px] relative z-20">
                <div className="grid md:grid-cols-4 gap-6">
                    {[
                        ...
                        <div key={i} className="bg-white rounded-xl p-6 shadow-xl shadow-gray-200/50 border border-gray-100 text-center group hover:translate-y-[-5px] transition-all duration-300">
                            <div className="w-10 h-10 rounded-lg bg-gray-50 flex items-center justify-center mx-auto mb-4 text-[var(--brand-primary)] group-hover:bg-[var(--brand-primary)] group-hover:text-white transition-colors">
                    ...
                    <div className="space-y-6">
                        <div className="space-y-3">
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[var(--brand-primary)]/5 border border-[var(--brand-primary)]/10">
                                    ...
                                    <span className="text-xs font-bold uppercase tracking-wider text-[var(--brand-primary)]">Mission</span>
                                </div>
                            <h2 className="text-3xl lg:text-4xl font-black text-[var(--brand-primary)] tracking-tight leading-tight">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-10">
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[var(--brand-primary)]/5 border border-[var(--brand-primary)]/10 mb-2">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[var(--brand-accent)]"></span>
                                    <span className="text-xs font-bold uppercase tracking-wider text-[var(--brand-primary)]">Objectives</span>
                                </div>
                        <h2 className="text-2xl font-black text-[var(--brand-primary)] tracking-tight">Strategic Mandate</h2>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={i} className="p-6 bg-white rounded-2xl shadow-xl shadow-gray-200/40 border border-gray-50 group hover:border-[var(--bcp-teal)] transition-all">
                                <div className="w-10 h-10 rounded-lg bg-[var(--brand-primary-soft)] flex items-center justify-center text-[var(--brand-primary)] mb-4 group-hover:scale-110 transition-transform">
                                    <i className={`fas ${obj.icon} text-sm`}></i>
                                </div>
                                <h3 className="text-lg font-black text-[var(--brand-primary)] mb-3">{obj.title}</h3>
            ...
            <section className="py-14 max-w-5xl mx-auto px-4">
                <div className="text-center mb-10">
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[var(--brand-primary)]/5 border border-[var(--brand-primary)]/10 mb-2">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[var(--brand-accent)]"></span>
                                    <span className="text-xs font-bold uppercase tracking-wider text-[var(--brand-primary)]">Timeline</span>
                                </div>
                    <h2 className="text-2xl font-black text-[var(--brand-primary)] tracking-tight">Placement Lifecycle</h2>
                </div>
                ...
                <div className="relative">
                    ...
                    <div className="space-y-8">
                        {[
                            ...
                            <div key={i} className="relative flex flex-col md:flex-row items-center md:items-start gap-6 group">
                                <div className="w-16 h-16 rounded-2xl bg-white border-2 border-gray-100 shadow-xl flex items-center justify-center text-xl font-black text-[var(--brand-primary)] group-hover:border-[var(--bcp-teal)] group-hover:text-[var(--bcp-teal)] transition-all z-10 flex-shrink-0">
                                    {item.step}
                                </div>
                                <div className="bg-white p-6 rounded-2xl shadow-lg shadow-gray-200/30 border border-gray-50 flex-grow group-hover:border-l-8 group-hover:border-l-[var(--bcp-teal)] transition-all">
                                    <h3 className="text-xl font-black text-[var(--brand-primary)] mb-2">{item.title}</h3>
            ...
            <section className="py-14 px-4">
                <div className="max-w-4xl mx-auto bg-[var(--brand-primary)] rounded-2xl p-8 lg:p-14 text-center text-white shadow-2xl relative overflow-hidden">
                    <h2 className="text-3xl lg:text-4xl font-black mb-6 relative z-10">Launch Your Professional Journey.</h2>
                    <p className="text-white/70 text-base font-medium mb-8 relative z-10 max-w-2xl mx-auto">
                        Connect with our Career Services team to explore global opportunities and refine your professional profile.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
                        <Link href="/admissions" className="bg-[var(--brand-accent)] text-white px-8 py-3 rounded-xl font-bold uppercase tracking-wider text-sm hover:shadow-2xl transition-all">
                            Join the Program
                        </Link>
                        <Link href="/contact" className="bg-white/10 text-white border border-white/20 px-8 py-3 rounded-xl font-bold uppercase tracking-wider text-sm hover:bg-white/20 transition-all">
                            Contact Cell
                        </Link>
                    </div>
                    {/* Background Accents */}
